...
tmux set -g status-style bg="#1b1b1b"
...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=#1F2335,bg=#803355,bold] #{?client_prefix,󰠠 ,#[dim]󰤂 }#[fg=#ffffff,bg=#803355,bold,nodim]#S $RESET"

#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "#[fg=#689d6a,bg=#242424,bold]   #[fg=#a9b1d6,bold]$window_number #[bold,nodim]#W#[nobold,dim] #{?window_last_flag,,}  "
# Unfocused
tmux set -g window-status-format "#[fg=#c0caf5,bg=#1e1e1e,none,dim]   $window_number #W#[nobold,dim]#[fg=yellow,blink] #{?window_last_flag,󰁯 ,} "
